...
# -----------------------------------------------------------------------------------------------------------
"""Three-loop batch paged attention for replay_graph ping-pong reuse profiling."""
...
class TestBatchPagedAttentionThreeLoop(SceneTestCase):
    RTOL = 1e-3
    ATOL = 1e-3
