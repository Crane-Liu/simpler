...
#ifndef SRC_A2A3_RUNTIME_REPLAY_GRAPH_RUNTIME_RUNTIME_H_
#define SRC_A2A3_RUNTIME_REPLAY_GRAPH_RUNTIME_RUNTIME_H_
...
struct alignas(64) DeviceRuntimeLaunchDesc {
    ...
    // Prebuilt-arena fast path. Set by the host before rtMemcpy'ing
...
public:
    ...
    // Prebuilt-arena fast path. Set by host's
...
#endif  // SRC_A2A3_RUNTIME_REPLAY_GRAPH_RUNTIME_RUNTIME_H_
