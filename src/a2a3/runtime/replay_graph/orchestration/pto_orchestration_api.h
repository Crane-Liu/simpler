...
typedef struct PTO2RuntimeOps {
    ...
    // Stage-1 graph/layer boundary hook. It is safe to omit in older runtimes;
    // the inline wrapper below checks for nullptr before calling.
