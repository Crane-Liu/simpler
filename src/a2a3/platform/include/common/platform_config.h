 ...
 * of 1024 records is ~2.3 MB. dep_gen captures the full submit stream and
 * larger replay_graph/qwen cases can submit well over 1K tasks in a few ms,
 * so small buffers churn through the free/ready queues and drop records
 * before the host collector can drain them.
 */
